...
protected:
	...
	{
		//correct map file
		char file2[147] = { 'I', 'm', 'p', 10, 0, 0, 0, 10, 0, 0, 0, 32, 0, 0, 0, 'A', 't', 'i', 'l', 'e', '1', '.', 'b', 'm', 'p', '|', 'B', 't', 'i', 'l', 'e', '2', '.', 'b', 'm', 'p', '|', 'C', 't', 'i', 'l', 'e', '3', '.', 'b', 'm', 'p', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'C', 'C', };
		//wrong signature
		char file1[145] = {'S', 10, 0,0,0, 10, 0, 0,0, 32,0,0,0, 'A', 't', 'i', 'l', 'e', '1', '.', 'b', 'm', 'p', '|', 'B', 't', 'i', 'l', 'e', '2', '.', 'b', 'm', 'p', '|', 'C', 't', 'i', 'l', 'e', '3', '.', 'b', 'm', 'p', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'C', 'C', };
		//non-existing tile-file
		char file3[147] = { 'I', 'm', 'p', 10, 0, 0, 0, 10, 0, 0, 0, 32, 0, 0, 0, 'A', 't', 'i', 'l', 'e', '1', '.', 'b', 'm', 'p', '|', 'B', 't', 'i', 'l', 'e', '2', '.', 'b', 'm', 'p', '|', 'C', 'e', 'm', 'p', 't', 'y', '.', 'b', 'm', 'p', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'C', 'C', };
		//wrong tiles definition
		char file4[147] = { 'I', 'm', 'p', 10, 0, 0, 0, 10, 0, 0, 0, 32, 0, 0, 0, 'A', 't', 'i', 'l', 'e', '1', '.', 'b', 'm', 'p', '|', 'B', 't', 'i', 'l', 'e', '2', '.', 'b', 'm', 'p', '|', 'C', 't', 'i', 'l', 'e', '3', '.', 'b', 'm', 'p', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'F', 'B', 'A', 'B', 'E', 'B', 'A', 'D', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'C', 'C', };
		std::ofstream file("tm_test1.map");
	
		
		file.write(file1, 148);
		file.close();
		file.open("tm_test2.map", std::ofstream::out);
	
		file.write(file2, 146);
		file.close();
		file.open("tm_test3.map", std::ofstream::out);
		file.write(file3, 148);
		file.close();
		file.open("tm_test4.map", std::ofstream::out);
		file.write(file4, 148);
		file.close();
	}
